...
import { programmes as initialProgrammes } from '../../../data/programmes';
...
export default function ProgrammesAdmin() {
  ...
  function saveEdit() {
    ...
    setProgrammes((prev) =>
      prev.map((p) =>
        p.slug === editing.slug
          ? { ...p, teaser: editing.teaserDraft, body, images: editing.imagesDraft }
          : p,
      ),
    );
    setEditing(null);
    ...
    <ProtectedSection section="programmes" title="Programmes">
      <div className={styles.toolbar}>
        <p className={styles.hint}>
          Editing here updates the demo in this session only — nothing is saved to a backend yet.
        </p>
      </div>
        ...
        <Modal
          ...
          footer={
            <>
              ...
              <button className="a-btn a-btn-primary" onClick={saveEdit}>Save changes</button>
            </>
          }
        >
          <div>
